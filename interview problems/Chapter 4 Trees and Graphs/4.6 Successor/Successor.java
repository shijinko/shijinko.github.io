...
public class Successor{
	...
	public static void main(String[] args){
		...
		if(isBST(root))
			...
			System.out.println( "the tree not is a balanced search tree" );
		
		
		System.out.println();
		System.out.println("Printing nodes from leat to greatest");
		count = 0;
		Treenode pnode = root;   
		...
		while(pnode != null){
			System.out.println("node " + count + ": " + pnode.payload());
			pnode = findSuccessor(pnode);
			count++;
		}
	}
}